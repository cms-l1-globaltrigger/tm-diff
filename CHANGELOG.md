...
- Depends on utm 0.14.0 (#17).

## [0.9.3] - 2025-12-19

### Changed

- Replaced explicit Git URL-based dependency installation to custom package index (#18).
...
[unreleased]: https://github.com/cms-l1-globaltrigger/tm-diff/compare/0.9.4...HEAD
[0.9.4]: https://github.com/cms-l1-globaltrigger/tm-diff/compare/0.9.3...0.9.4
